...
function Calendar({ className, classNames, showOutsideDays = true, locale = locale_1.id, ...props }) {
    return (<react_day_picker_1.DayPicker showOutsideDays={showOutsideDays} className={(0, utils_1.cn)("p-3", className)} locale={locale} classNames={{
